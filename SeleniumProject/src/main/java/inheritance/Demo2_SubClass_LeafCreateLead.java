...
import wrapper.Demo2_Befor_AfterMethod;

public class Demo2_SubClass_LeafCreateLead extends Demo2_Befor_AfterMethod {
	
	//@Test()
	//public void demo2_subClass() {
	
	@Test(dataProvider ="getData")
	public void demo2_subClass(String comName,String fName,String lName) {
		...
		driver.findElement(By.xpath("//input[@id=\"createLeadForm_companyName\"]")).sendKeys(comName); 
